...
const faqItems: FAQItem[] = [
  {
    question: 'What is cheap Discord Nitro?',
    answer: 'Cheap Discord Nitro refers to affordable subscription plans that give you access to premium Discord features at competitive prices. Our service provides legitimate Discord Nitro subscriptions at the best market rates.',
  },
  {
    question: 'Is buying cheap Discord Nitro safe?',
    answer: 'Yes, our Discord Nitro service is completely safe and legitimate. We use secure payment methods and deliver subscriptions through official channels, ensuring your account remains protected.',
  },
  {
    question: 'How fast is Discord Nitro delivered?',
    answer: 'Discord Nitro is delivered instantly after purchase. Our automated system processes your order within seconds, and you\'ll receive your subscription immediately.',
  },
  {
    question: 'What are cheap Discord server boosts?',
    answer: 'Discord server boosts are premium features that enhance your server with better audio quality, more emoji slots, custom server banners, and other perks. We offer these at affordable prices.',
  },
  {
    question: 'Why choose Boostmania for Discord boosts?',
    answer: 'Boostmania offers the best combination of competitive pricing, instant delivery, reliable service, and 24/7 customer support. We\'ve been trusted by thousands of customers since 2019.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center mb-16 lg:mb-20">
          ...
          <p className="text-xl text-zinc-400 max-w-2xl font-normal">
            Everything you need to know about our services, payments, and support.
          </p>
        </div>
